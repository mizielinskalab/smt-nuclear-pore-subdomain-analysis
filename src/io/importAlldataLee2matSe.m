function [bData31_1dataAll, bData31_1PositionAll, bData31_2dataAll, bData31_2PositionAll] = importAlldataLee2matSe(aFolderName,a01,aC31,aSelection4)
% 2019/05/20
...
for ss=aSelection4
    ...
    bData31_1dataAll{ss,:} = [];
    bData31_1PositionAll{ss,:} = [];
    bData31_2dataAll{ss,:} = [];
    bData31_2PositionAll{ss,:} =[];
end
    bData31_1dataAll=bData31_1dataAll(~any(cellfun('isempty', bData31_1dataAll), 2), :); 
    bData31_1PositionAll=bData31_1PositionAll(~any(cellfun('isempty', bData31_1PositionAll), 2), :); 
    bData31_2dataAll=bData31_2dataAll(~any(cellfun('isempty', bData31_2dataAll), 2), :); 
    bData31_2PositionAll=bData31_2PositionAll(~any(cellfun('isempty', bData31_2PositionAll), 2), :); 
end
